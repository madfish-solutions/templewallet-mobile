...
export const useFavouriteTokens = () => useSelector(state => state.market.favouriteTokens);

export const useMarketCoinSlug = (id: string) => useSelector(state => state.market.tokensSlugs.data[id]);
