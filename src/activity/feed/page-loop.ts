...
// A page often parses to zero rows (everything in it was filtered out) - keep scanning until one
// yields, but only up to the budget, so a long filtered stretch stops instead of hammering the API
