...
export const Send: FC<ActivityItemProps> = ({ activity }) => {
  ...
  return (
    <AbstractItem
      face={<Face address={activity.to?.address ?? activity.hash} nonZeroAmounts={nonZeroAmounts} />}
      details={<Details hash={activity.hash} address={activity.to?.address ?? ''} nonZeroAmounts={nonZeroAmounts} />}
