...
export const MT_PELERIN_ACTIVATION_KEY = getEnv('MT_PELERIN_ACTIVATION_KEY');
export const MT_PELERIN_REF_CODE = getEnv('MT_PELERIN_REF_CODE');
...
export const UNIVERSAL_LINKS_DOMAIN_URI_PREFIX = getEnv('UNIVERSAL_LINKS_DOMAIN_URI_PREFIX');

export const APK_BUILD_ID = getEnv('APK_BUILD_ID');

export const HYPELAB_AD_FRAME_URL = getEnv('HYPELAB_AD_FRAME_URL');
export const HYPELAB_MEDIUM_PLACEMENT_SLUG = getEnv('HYPELAB_MEDIUM_PLACEMENT_SLUG');
export const HYPELAB_NATIVE_PLACEMENT_SLUG = getEnv('HYPELAB_NATIVE_PLACEMENT_SLUG');

export const TEMPLE_ADS_API_URL = getEnv('TEMPLE_ADS_API_URL');
