...
// export const transformFa12ActivityToActivityGroup = (activites: ActivityInterface[]) => {
//   const result: ActivityGroup[] = [];
...
// export const transformFa2ActivityToActivityGroup = (activites: ActivityInterface[]) => {
//   const result: ActivityGroup[] = [];
