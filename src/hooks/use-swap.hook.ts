...
import { Route3Chain, Route3ContractInterface } from 'src/interfaces/route3.interface';
...
export const useSwap = () => {
  ...
  return useCallback(
    async (
      ...
      const inputAmountAtomic = new BigNumber(inputAmount ?? 0).multipliedBy(10 ** fromToken.decimals);
