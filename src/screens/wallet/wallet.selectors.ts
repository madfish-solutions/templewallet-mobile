export enum WalletSelectors {
  accountDropdownButton = 'Wallet/Account Dropdown Button',
  ...
  swapButton = 'Wallet/Buy Buton',
  sendButton = 'Wallet/Send Buton',
  collectiblesButton = 'Wallet/Collectibles Buton',
  hideZeroBalancesCheckbox = 'Wallet/Hide Zero Balances Checkbox',
  activityButton = 'Wallet/Activity Buton',
