...
interface AssetAmountInputComponentAdditionalProps {
  meta: FieldMetaProps<TopUpAssetAmountInterface>;
...
const defaultNewValueAssetChangedFn: AssetAmountInputComponentAdditionalProps['newValueAssetChangedFn'] = (
...
const AssetAmountInputComponent: FC<TopUpAssetAmountInputProps & AssetAmountInputComponentAdditionalProps> = ({
  ...
  setSearchValue,
  meta,
  newValueAssetChangedFn = defaultNewValueAssetChangedFn,
  onBlur,
  onFocus,
  onValueChange
}) => {
  ...
  const handleTokenChange = useCallback(
    (newAsset?: TopUpInputInterface) => {
      if (isDefined(newAsset)) {
        onValueChange(newValueAssetChangedFn(newAsset, inputValueRef.current));
      }
    },
    [onValueChange]
  );
