...
import { IncomingRequestInterceptor } from '@airgap/beacon-sdk/dist/cjs/interceptors/IncomingRequestInterceptor';
import { OutgoingResponseInterceptor } from '@airgap/beacon-sdk/dist/cjs/interceptors/OutgoingResponseInterceptor';
...
export class WalletClient extends Client {
  ...
  public async connect(
    newMessageCallback: (message: BeaconRequestOutputMessage, connectionContext: ConnectionContext) => void
  ): Promise<void> {
