export enum SendModalSelectors {
  assetInput = 'Send (Modal)/Asset Input',
  toInput = 'Send (Modal)/To Input',
  transferBetweenMyAccountsCheckBox = 'Send (Modal)/Transef Between My Accounts Check Box',
