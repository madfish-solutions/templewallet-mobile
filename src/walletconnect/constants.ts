...
export const EVM_WC_MODERN_TYPED_DATA_METHODS = ['eth_signTypedData_v3', 'eth_signTypedData_v4'] as const;

const EVM_WC_TYPED_DATA_METHODS = [...EVM_WC_OLD_TYPED_DATA_METHODS, ...EVM_WC_MODERN_TYPED_DATA_METHODS] as const;
