Feature: Create new wallet
  ...
  Scenario: As a user, I'd like to create account with new seed phrase
    ...
    And I enter password into Password Input on Create a new Wallet page
    And I enter password into Repeat Password Input on Create a new Wallet page
    And I press Accept Terms Checkbox on Create a new Wallet page
    And I press Create button on Create a new Wallet page
